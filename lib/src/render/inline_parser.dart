  ...
  void _processEmphasis(int bottomIndex) {
    ...
    while (currentIndex < _delimiterStack.length) {
      ...
      if (openerIndex > bottomIndex && openerIndex > openerBottom) {
        ...
        _tree.replaceRange(openerTextNodeIndex + 1, closerTextNodeIndex, [node!]);
        ...
        if ((strong && openerTextNode.text.length == 2) || (!strong && openerTextNode.text.length == 1)) {
        ...
        if ((strong && closerTextNode.text.length == 2) || (!strong && closerTextNode.text.length == 1)) {
